    ...
    <div class="container">
        <div class="row">
            <div class="col-6 offset-3">
                <div class="card">
                    <h4 class="card-header text-center">Edit  Admin/User</h4>
                    <div class="card-body card-block">
                        <form action="{{route('adminUsers.update',$data->id)}}" method="post" class="form">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-actions form-group">
                                ...
                                <a href="#"><button type = 'button'   class="btn btn-success btn-sm">Back</button></a>
                            </div>
                        </form>
                    </div>
                </div>
